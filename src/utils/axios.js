 ...
 * @FilePath: \vue-cli-template-master\vue-cli-template-master\src\utils\axios.js
 */ 
...
axios.interceptors.response.use(response => {
  ...
  if (!response.data) {
    ...
    window.common.showToast(response.data.message || '请求出现错误')
    return Promise.reject(new Error(response.data.message || '请求出现错误'))
  }
  return {
    data: response.data,
